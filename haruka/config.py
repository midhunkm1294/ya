...
class Config(object):
    ...
    # REQUIRED
    API_KEY = ""
    OWNER_ID = "953414679"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "pureindialover"
    ...
    WEBHOOK = ANYTHING
    URL = "https://killerbotapp.herokuapp.com"
